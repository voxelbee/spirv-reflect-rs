...
pub type SpvReflectResult = ::std::os::raw::c_int;
...
#[doc = ""]
#[doc = "SPV_REFLECT_MODULE_FLAG_NO_COPY - Disables copying of SPIR-V code"]
#[doc = "when a SPIRV-Reflect shader module is created. It is the"]
#[doc = "responsibility of the calling program to ensure that the pointer"]
#[doc = "remains valid and the memory it's pointing to is not freed while"]
#[doc = "SPIRV-Reflect operations are taking place. Freeing the backing"]
#[doc = "memory will cause undefined behavior or most likely a crash."]
#[doc = "This is flag is intended for cases where the memory overhead of"]
#[doc = "storing the copied SPIR-V is undesirable."]
pub type SpvReflectModuleFlagBits = ::std::os::raw::c_int;
...
pub type SpvReflectTypeFlagBits = ::std::os::raw::c_int;
...
#[doc = ""]
#[doc = "NOTE: HLSL row_major and column_major decorations are reversed"]
#[doc = "in SPIR-V. Meaning that matrices declrations with row_major"]
#[doc = "will get reflected as column_major and vice versa. The"]
#[doc = "row and column decorations get appied during the compilation."]
#[doc = "SPIRV-Reflect reads the data as is and does not make any"]
#[doc = "attempt to correct it to match what's in the source."]
pub type SpvReflectDecorationFlagBits = ::std::os::raw::c_int;
...
pub type SpvReflectResourceType = ::std::os::raw::c_int;
...
pub type SpvReflectFormat = ::std::os::raw::c_int;
...
pub type SpvReflectVariableFlagBits = ::std::os::raw::c_int;
...
pub type SpvReflectDescriptorType = ::std::os::raw::c_int;
...
pub type SpvReflectShaderStageFlagBits = ::std::os::raw::c_int;
...
pub type SpvReflectGenerator = ::std::os::raw::c_int;
pub const SPV_REFLECT_MAX_ARRAY_DIMS: ::std::os::raw::c_int = 32;
pub const SPV_REFLECT_MAX_DESCRIPTOR_SETS: ::std::os::raw::c_int = 64;
pub type _bindgen_ty_1 = ::std::os::raw::c_int;
pub const SPV_REFLECT_BINDING_NUMBER_DONT_CHANGE: ::std::os::raw::c_int = -1;
pub const SPV_REFLECT_SET_NUMBER_DONT_CHANGE: ::std::os::raw::c_int = -1;
...
pub struct SpvReflectShaderModule_Internal {
    ...
    pub spirv_size: size_t,
    pub spirv_code: *mut u32,
    pub spirv_word_count: u32,
    pub type_description_count: size_t,
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "@param  flags     Flags for module creations."]
    #[doc = "@param  size      Size in bytes of SPIR-V code."]
    #[doc = "@param  p_code    Pointer to SPIR-V code."]
    #[doc = "@param  p_module  Pointer to an instance of SpvReflectShaderModule."]
    #[doc = "@return           SPV_REFLECT_RESULT_SUCCESS on success."]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "@param  p_var Pointer to block variable."]
    #[doc = "@return Returns string of block variable's type description type name"]
    #[doc = "or NULL if p_var is NULL."]
